# Task 1 — STL-10 inductive biases
...
| Evidence | Files |
| --- | --- |
| Experiment settings and hypotheses | [task1.yaml](configs/task1.yaml) |
| Train, validation, and evaluation identifiers | [split manifests](results/splits/) |
| Training histories and selected epochs | [training records](results/training/) |
| Clean accuracy, macro-F1, confidence, and predictions | [clean results](results/clean/) |
| Grayscale and hue-rotation results | [color results](results/color/) |
| Clean/color/patch compact comparison | [PNG](results/comparison/compact_comparison.png), [CSV](results/comparison/compact_comparison.csv), [record](results/comparison/compact_comparison_record.json) |
| Cue selection, rejection records, counts, and predictions | [cue-conflict results](results/cue_conflict/) |
| Three selected cue-conflict examples | [PNG](results/cue_conflict/figures/selected_examples.png), [predictions](results/cue_conflict/figures/selected_predictions.csv) |
| Translation curves | [final PNG](results/translation/figures/translation_curves_final.png), [CSV](results/translation/figures/translation_curves.csv) |
| Translation directions and image hashes | [directional results](results/translation/), [input manifests](results/translation/inputs/) |
| Patch permutations and predictions | [patch-shuffle results](results/patch_shuffle/) |
| Paired cosine stability | [summaries and per-pair CSVs](results/feature_similarity/) |
| Fixed UMAP selection and coordinates | [selection](results/representation/umap_selection.csv), [coordinates, figures, and records](results/representation/umap/) |
...
Release download URLs, upstream source-file hashes, license-file hash, file sizes, and the resolved commit are recorded in [adain_source.json](results/cue_conflict/adain_source.json). `setup_adain.py` obtains that checkout and the release weights; large external assets are stored outside Git.
